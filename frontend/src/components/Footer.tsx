...
const Footer = () => {
  return (
    <div className="footer">
      <div className="container flex justify-between items-center text-white py-[90px]">
        <div className="footer_content_1">
          <Link to="/">
            <img src="logo.png" className="mb-8" />
          </Link>
          <p className="max-w-[347px] mb-7 leading-[1.7] font-medium">
          ...
          <div className="text-primary flex gap-[25px]">
            <Link to="">
              <svg
        ...
        <div className="footer_content_2">
          ...
          <p className="flex gap-3 mb-[25px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
            ...
            <span className="leading-[1.7] font-medium max-w-[300px]">
              Địa chỉ: Tâng 6 toà nhà Ladeco, 266 Đội Cấn, phường Liễu Giai, Hà
              Nội, Vietnam
            </span>
          </p>
          <div className="flex gap-3 ">
            ...
            <p className="leading-[1.7] font-medium">
              <span className="block">Hotline đặt bàn: 1900 6750</span>
              <span className="block">Hotline giao hàng: 1900 6750</span>
            </p>
          </div>
        </div>
        <div className="footer_content_3">
          ...
          <p className="leading-[1.7] mb-[25px] max-w-[332px] font-medium">
            Đừng bỏ lỡ những sản phẩm và chương trình khuyến mãi hấp dẫn
          </p>
          <div className="rounded-full bg-white min-w-[356px]">
            <input
              type="text"
              className="rounded-full p-5 text-black font-medium"
              placeholder="Email của bạn"
            />
            <Link to="" className="bg-primary py-5 px-10 rounded-full">
              Đăng ký
            </Link>
          </div>
        </div>
